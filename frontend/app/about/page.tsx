      ...
      <main className="bg-white">
        ...
        <section className="pt-6 md:pt-10 pb-20 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-medium text-primary uppercase tracking-[0.2em]">{language === "kh" ? "ប្រវត្តិក្រុមហ៊ុន YSG Group" : "YSG Group Legacy"}</span>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8 animate-in fade-in slide-in-from-left duration-700">
               <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-medium text-slate-900 mb-6 uppercase tracking-tight">
                  ...
                  <div className="flex items-center gap-3 text-primary font-medium text-[11px] uppercase tracking-widest">
               ...
               <div className="bg-slate-900 p-10 rounded-[2.5rem] text-white space-y-6">
                  ...
                  <div className="pt-4 border-t border-white/10 grid grid-cols-2 gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-medium uppercase tracking-widest text-slate-300">{language === "kh" ? "គុណភាព ១០០%" : "100% Quality"}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Globe className="w-4 h-4 text-primary" />
                      <span className="text-[10px] font-medium uppercase tracking-widest text-slate-300">{language === "kh" ? "ស្តង់ដារសកល" : "Global Standards"}</span>
                    </div>
                  </div>
               </div>
            </div>
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-right duration-700">
              <h2 className="text-2xl font-medium text-slate-900 uppercase tracking-tight">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-4 bg-white rounded-xl border border-slate-100 shadow-sm hover:border-primary/20 transition-all">
                    <div className="w-2 h-2 bg-primary rounded-full" />
                    <span className="font-medium text-slate-700 uppercase text-[12px] tracking-wide">{item}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-24 px-6">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((item, i) => (
              <div key={i} className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-slate-200/50 transition-all group flex flex-col items-center text-center">
                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center text-primary mb-8 border border-slate-50 group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                  <item.icon className="w-7 h-7" />
                </div>
                <h3 className="font-medium text-[16px] text-slate-900 mb-4 tracking-tight uppercase">{item.title}</h3>
                <p className="text-slate-600 font-normal leading-relaxed text-[13px]">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 pb-32">
          <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl space-y-6">
               <span className="text-[11px] font-medium text-primary uppercase tracking-[0.3em]">{language === "kh" ? "ដោះស្រាយបញ្ហាឧស្សាហកម្ម" : "Solving Industrial Challenges"}</span>
               <h2 className="text-2xl md:text-3xl font-medium tracking-tight uppercase">
