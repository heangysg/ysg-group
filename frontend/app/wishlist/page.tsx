    ...
    <PublicLayout>
      <main className="bg-white min-h-screen pb-24 pt-4 md:pt-6 font-sans">
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-200">
            ...
            {wishlistItems.length > 0 && (
              <button 
                ...
                className="text-xs sm:text-sm font-bold text-slate-600 hover:text-red-600 transition-colors bg-white border border-slate-200 hover:border-red-200 hover:bg-red-50 px-4 py-2.5 rounded-lg shadow-2xs flex items-center gap-2 self-start sm:self-center"
              >
          ...
          {wishlistItems.length === 0 ? (
            <div className="py-24 text-center bg-white rounded-2xl border border-slate-200 shadow-2xs flex flex-col items-center justify-center my-8">
              <div className="w-20 h-20 bg-blue-50 text-[#004691] rounded-full flex items-center justify-center mb-4">
              ...
              <Link 
                href="/products" 
                className="inline-flex items-center gap-2 bg-[#004691] hover:bg-[#003366] text-white px-8 py-3.5 rounded-lg font-bold text-xs sm:text-sm transition-all shadow-md active:scale-95"
              >
