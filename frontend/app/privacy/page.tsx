...
export default function PrivacyPage() {
  ...
  const sections = language === "kh" ? [
    ...
    { title: "ความsafe ទិន្នន័យ", body: "យើងប្រើប្រព័ន្ធសុវត្ថិភាព SSL encryption ដើម្បីការពារទិន្នន័យរបស់អ្នកអំឡុងពេលបញ្ជូន និងផ្ទុក។ ព័ត៌មានរបស់អ្នកត្រូវបានផ្ទុកនៅលើម៉ាស៊ីនមេដែលមានសុវត្ថិភាព។" },
