...
export default function CartPage() {
 ...
 <span className="bg-blue-50 text-[#004691] text-xs sm:text-sm font-bold px-2.5 py-0.5 sm:py-1 rounded-md border border-blue-100 shrink-0">
 ...
 {items.length === 0 ? (
 <div className="bg-slate-50 rounded-md p-8 sm:p-12 text-center border border-slate-200 shadow-2xs flex flex-col items-center justify-center my-6 max-w-2xl mx-auto">
 <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-md border border-slate-200 flex items-center justify-center mb-4 shadow-2xs">
 ...
 <Link
 href="/products"
 className="px-6 sm:px-8 py-3 sm:py-3.5 bg-[#004691] text-white text-xs sm:text-sm font-bold rounded-md hover:bg-[#003366] transition-all shadow-2xs active:scale-95 flex items-center gap-2"
 >
 ...
 <div
 key={item.id}
 className="bg-white p-3.5 sm:p-5 rounded-md border border-slate-200 shadow-2xs flex gap-3 sm:gap-4 items-center hover:border-slate-300 transition-all"
 >
 <div className="w-16 h-16 sm:w-20 sm:h-20 bg-slate-50 rounded-md border border-slate-200 p-1 flex items-center justify-center shrink-0 overflow-hidden">
 ...
 <h3 className="text-xs sm:text-base font-bold text-slate-900 truncate mb-1">
 {language === "kh" && item.nameKhmer ? item.nameKhmer : item.name}
 </h3>
 <span className="text-xs sm:text-sm font-bold text-red-600 block mb-2 sm:mb-3">
 ...
 className="w-6 h-6 sm:w-7 sm:h-7 rounded-md bg-white text-slate-700 hover:bg-slate-200 flex items-center justify-center font-bold text-xs shadow-2xs"
 >
 <Minus className="w-3 h-3" />
 </button>
 <span className="w-7 sm:w-8 text-center text-xs font-bold text-slate-900">
 {item.quantity}
 </span>
 <button
 ...
 {language === "kh" ? "សរុប:" : "Total:"} <span className="text-red-600 font-bold">${(item.price * item.quantity).toLocaleString()}</span>
 </span>
 </div>
 </div>
 ...
 className="p-1.5 sm:p-2 text-slate-300 hover:text-red-500 rounded-md hover:bg-red-50 transition-all shrink-0"
 >
 ...
 <div className="bg-slate-50 border border-slate-200 p-4 sm:p-8 rounded-md shadow-2xs space-y-4 sm:space-y-6 lg:sticky lg:top-24">
 <h2 className="text-base sm:text-lg font-bold text-slate-900 border-b border-slate-200 pb-3">
 ...
 <span className="text-xl sm:text-2xl font-bold text-[#004691]">${cartTotal.toLocaleString()}</span>
 </div>

 <button
 onClick={() => router.push("/checkout")}
 className="w-full py-3.5 sm:py-4 bg-[#004691] hover:bg-[#003366] text-white rounded-md font-bold text-sm sm:text-base flex items-center justify-center gap-2 shadow-md transition-all active:scale-95 cursor-pointer"
 >
