...
export default function OrderTrackingPage() {
 ...
 <div className="max-w-2xl mx-auto bg-slate-50 border border-slate-200 rounded-md p-6 sm:p-8 shadow-2xs mb-10">
 <div className="text-center mb-6">
 <div className="w-12 h-12 bg-blue-50 text-[#004691] rounded-md flex items-center justify-center mx-auto mb-3">
 ...
 className="w-full pl-11 pr-4 py-3 bg-white border border-slate-300 rounded-md text-sm font-semibold text-slate-900 focus:outline-none focus:border-[#004691] focus:ring-2 focus:ring-[#004691]/20 shadow-2xs"
 />
 </div>
 <button
 type="submit"
 disabled={loading}
 className="bg-[#004691] hover:bg-[#003366] text-white font-bold px-6 py-3 rounded-md text-sm transition-all shadow-2xs shrink-0 flex items-center justify-center gap-2 active:scale-95"
 >
 {loading ? (
 ...
 {orders.length > 0 ? (
 orders.map((order) => (
 <div key={order.id} className="bg-white border border-slate-200 rounded-md p-5 sm:p-6 shadow-2xs hover:border-[#004691] transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4">
 <div className="space-y-2">
 <div className="flex items-center gap-3 flex-wrap">
 <span className="font-bold text-slate-900 text-base sm:text-lg">
 #{order.id?.substring(0, 8).toUpperCase()}
 </span>
 <span className={`text-xs font-bold px-3 py-1 rounded-md border ${getStatusStyle(order.paymentStatus || order.status)}`}>
 ...
 <span className="text-lg sm:text-xl font-bold text-[#004691]">
 ...
 className="bg-slate-100 hover:bg-[#004691] hover:text-white text-slate-800 font-bold px-4 py-2.5 rounded-md text-xs transition-all flex items-center gap-1 shrink-0"
 >
 ...
 <div className="bg-slate-50 border border-slate-200 rounded-md p-10 text-center space-y-3">
 <div className="w-12 h-12 bg-amber-50 text-amber-600 rounded-md flex items-center justify-center mx-auto">
