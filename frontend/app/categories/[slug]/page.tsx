    ...
    return (
      <PublicLayout>
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          ...
          <h1 className="text-4xl font-black text-gray-900 mb-4">Category Not Found</h1>
          <p className="text-gray-500 mb-8">We couldn't find the category you're looking for.</p>
          <a href="/categories" className="bg-primary text-white px-8 py-4 rounded-2xl font-black">
            Back to Categories
          </a>
        </div>
      </PublicLayout>
