...
export default function AuditLogsPage() {
 ...
 <div>
 <h2 className="text-2xl font-bold uppercase text-slate-900">{t("auditLogs")}</h2>
 ...
 {loading ? (
 <tr><td colSpan={5} className="px-6 py-12 text-center text-slate-500 font-bold font-medium text-xs">{t("loading")}</td></tr>
 ) : filteredLogs.length === 0 ? (
 <tr><td colSpan={5} className="px-6 py-12 text-center text-slate-500 font-bold font-medium text-xs">{t("noActivityFound")}</td></tr>
 ) : (
 ...
 <span className="text-xs font-bold text-slate-900 font-medium">{log.user_email}</span>
 </div>
 </td>
 <td className="px-6 py-4">
