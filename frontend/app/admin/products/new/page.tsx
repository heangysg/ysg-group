...
export default function AddProduct() {
 ...
 return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center gap-4">
        <button
          onClick={() => router.back()}
          className="self-start p-2.5 bg-white border border-slate-200 shadow-sm hover:translate-y-1 hover:translate-x-1 hover:shadow-none transition-all text-slate-900"
        >
          <ArrowLeft className="w-4 h-4" />
        </button>
        <div className="flex items-center gap-4">
          <div className="p-3 bg-primary text-white border border-slate-200 shadow-sm">
            <Package className="w-5 h-5 text-white" />
          </div>
          <div>
            <h1 className="text-xl font-bold uppercase text-slate-900">{t("addProduct")}</h1>
            <p className="text-xs font-medium text-slate-500 mt-1">{t("fillInDetails")}</p>
          </div>
        </div>
      </div>
 ...
 <select
 className="w-full px-4 py-3 bg-white border border-slate-200 outline-none transition-all font-bold text-sm text-slate-900 font-medium"
 ...
 <input
 type="number"
 className="w-full pl-12 pr-5 py-4 bg-slate-50 border border-slate-200 focus:bg-white outline-none transition-all font-bold text-xs text-slate-900 font-medium"
 ...
 <div key={i} className="relative group border border-slate-200 shadow-sm bg-white">
 ...
 <textarea
 rows={4}
 className="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:bg-white outline-none transition-all font-bold text-xs text-slate-900 tracking-wide resize-none"
 ...
 className="w-6 h-6 border border-slate-200 accent-primary shadow-sm"
 />
 ...
 type="button"
 onClick={() => router.back()}
 className="px-8 py-4 bg-white border border-slate-200 text-slate-900 font-bold text-xs font-medium hover:bg-slate-50 hover:shadow-sm transition-all"
 >
 {t("cancel")}
 </button>
 <button
