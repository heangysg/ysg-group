...
export default function LanguageTest() {
 ...
 className={`px-4 py-2 rounded-md ${language === "en" ? "bg-primary text-white" : "bg-gray-200"}`}
 >
 English
 </button>
 <button
 onClick={() => setLanguage("kh")}
 className={`px-4 py-2 rounded-md ${language === "kh" ? "bg-primary text-white" : "bg-gray-200"}`}
 >
 Khmer
 </button>
 </div>
