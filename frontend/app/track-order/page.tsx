...
export default function TrackOrderPage() {
 ...
 <div className="w-16 h-16 bg-white shadow-sm border border-slate-100 rounded-md flex items-center justify-center mx-auto text-primary mb-6">
 ...
 <div className="solid-card bg-white p-6 md:p-8 rounded-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden">
 <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-primary/5 rounded-md blur-[60px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
 ...
 className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-md text-slate-900 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all font-medium placeholder:text-slate-400"
 />
 </div>
 </div>
 ...
 type="submit" 
 disabled={loading}
 className="w-full flex items-center justify-center gap-2 bg-slate-900 text-white px-6 py-4 rounded-md font-bold transition-all hover:bg-slate-800 active:scale-[0.98] shadow-lg disabled:opacity-70 disabled:pointer-events-none"
 >
 {loading ? (
