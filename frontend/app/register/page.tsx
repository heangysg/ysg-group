        ...
        >
          ...
          <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-xl border border-slate-200">
            {isSubmitted ? (
              ...
              >
                <div className="w-16 h-16 bg-blue-50 text-[#004691] rounded-full flex items-center justify-center border border-blue-100 shadow-2xs">
                ...
                <Link 
                  href="/login" 
                  className="w-full py-4 bg-[#004691] hover:bg-[#003366] text-white text-sm sm:text-base rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-md active:scale-95"
                >
