...
export async function generateMetadata(): Promise<Metadata> {
 ...
 let meta_title = "Yeung Shi Group - Premium Food & Packaging Machinery Solutions"
 let meta_description = "Quality machinery for food processing, agriculture, and packaging applications"
