...
export default function ShippingPage() {
 ...
 return (
 <div key={i} className="bg-white border border-slate-100 rounded-md p-6 md:p-8 flex gap-5">
 <div className="w-11 h-11 bg-primary/10 text-primary rounded-md flex items-center justify-center shrink-0 mt-0.5">
 ...
 <div className="mt-8 bg-primary/5 border border-primary/20 rounded-md p-6 md:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
 <div>
 ...
 <Link href="/contact" className="bg-slate-900 text-white px-6 py-3 rounded-md font-bold text-sm hover:bg-primary transition-all whitespace-nowrap">
