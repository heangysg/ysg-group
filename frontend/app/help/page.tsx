...
export default function HelpPage() {
 ...
 <div className="mt-10 bg-blue-50/60 border border-blue-100 rounded-md p-6 md:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
 <div>
 ...
 <Link href="/contact" className="bg-[#004691] text-white px-6 py-3 rounded-md font-bold text-sm hover:bg-[#003366] transition-all whitespace-nowrap shadow-2xs">
