...
export default function BakongQRModal({ isOpen, onClose, qrString, amount, orderId, md5, expiresAt, onSuccess, onExpire }: BakongQRModalProps) {
 ...
 {/* Merchant Name */}
 <h2 className="text-[15px] font-bold text-slate-900 leading-tight mb-2 mt-1 uppercase tracking-wide">
 {merchantName}
 </h2>
 ...
 <span className="text-[36px] font-medium text-slate-900 leading-none ">
 {amount}
 </span>
 ...
 {isChecking && (
 <div className="absolute bottom-4 right-4 flex items-center gap-2 text-emerald-500 bg-emerald-50 px-3 py-1 rounded-md text-xs font-medium animate-pulse">
