...
*សារ (Message):* ${inquiryForm.message}`
 ...
 <div className="bg-white rounded-md aspect-square relative overflow-hidden flex items-center justify-center p-6 shadow-2xs border border-slate-100">
 ...
 className={`w-20 h-20 bg-white rounded-md overflow-hidden shrink-0 border-2 transition-all p-1 ${
 ...
 <button 
 onClick={handleShare}
 className="w-9 h-9 rounded-md flex items-center justify-center bg-[#1E3A5F] text-white hover:bg-[#004691] transition-all shadow-2xs"
 >
 ...
 {/* Price Tag */}
 <div className="pt-2">
 <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-red-600 font-sans">
 ...
 {/* Quantity Controls */}
 <div className="flex items-center bg-slate-100 rounded-md border border-slate-200 px-3 py-1.5">
 <button 
 onClick={() => setQuantity(Math.max(1, quantity - 1))}
 className="text-slate-600 hover:text-slate-900 font-bold text-lg px-2"
 >
 -
 </button>
 <span className="w-10 text-center font-bold text-sm text-slate-900 font-sans">
 {quantity}
 </span>
 <button 
 ...
 className="flex-1 min-w-[200px] py-3 px-6 bg-[#1E3A5F] hover:bg-[#004691] text-white rounded-md font-bold text-xs md:text-sm flex items-center justify-center gap-2.5 shadow-xs transition-all active:scale-95 uppercase tracking-wider"
 >
 ...
 <h2 className="text-xl md:text-2xl font-bold text-[#004691] ">
 ...
 <h2 className="text-2xl font-bold text-slate-900 mb-2">{t("contactSales")}</h2>
 ...
 <input required value={inquiryForm.customerName} onChange={(e) => setInquiryForm({ ...inquiryForm, customerName: e.target.value })} type="text" className="w-full px-5 py-4 bg-slate-50 rounded-md border border-slate-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all font-medium text-slate-900 text-sm sm:text-base" />
 </div>
 <div>
 ...
 <input required value={inquiryForm.customerPhone} onChange={(e) => setInquiryForm({ ...inquiryForm, customerPhone: e.target.value })} type="tel" className="w-full px-5 py-4 bg-slate-50 rounded-md border border-slate-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all font-medium text-slate-900 text-sm sm:text-base" />
 </div>
 <div>
 <label className="block text-xs sm:text-sm font-bold text-slate-700 mb-2 uppercase tracking-wider">{t("message") || "Message"}</label>
 <textarea required value={inquiryForm.message} onChange={(e) => setInquiryForm({ ...inquiryForm, message: e.target.value })} rows={4} className="w-full px-5 py-4 bg-slate-50 rounded-md border border-slate-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all font-medium text-slate-900 text-sm sm:text-base resize-none"></textarea>
 </div>
 <button disabled={submittingInquiry} type="submit" className="w-full bg-primary text-white rounded-md py-4 font-bold text-sm sm:text-base mt-6 flex items-center justify-center gap-2 hover:bg-primary-dark transition-all active:scale-95 shadow-lg shadow-primary/30">
