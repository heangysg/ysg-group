          ...
          <div className="p-4 border-b border-slate-100 bg-white">
            ...
            {items.length > 0 && (
              <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-sm">
                ...
                <span className="text-lg font-black text-[#004691]">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {items.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-6 text-slate-400 space-y-3">
                ...
                <button
                  onClick={closeCart}
                  className="px-6 py-2 bg-[#004691] text-white text-xs font-bold rounded-full hover:bg-[#003366] transition-all"
                >
              ...
              items.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl border border-slate-100 relative"
                >
                  <div className="w-16 h-16 bg-white rounded-lg border border-slate-200 shrink-0 overflow-hidden p-1 flex items-center justify-center">
                    {item.image ? (
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center bg-white rounded-full border border-slate-200 p-0.5">
                        <button
                          ...
                          className="w-5 h-5 rounded-full hover:bg-slate-100 flex items-center justify-center text-slate-600 text-xs font-bold"
                        >
