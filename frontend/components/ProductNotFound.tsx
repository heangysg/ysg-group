...
export default function ProductNotFound() {
 ...
 <div className="text-[7rem] sm:text-[10rem] md:text-[14rem] font-bold text-slate-100 leading-none er">
 404
 </div>
 <div className="absolute inset-0 flex items-center justify-center">
 <div className="inline-flex p-4 sm:p-6 bg-slate-50 text-slate-400 rounded-md mb-6 shadow-sm border border-slate-100">
