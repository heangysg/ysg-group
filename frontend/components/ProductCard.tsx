        ...
        <div className="mt-auto flex flex-wrap items-center justify-between gap-y-2 gap-x-1">
          ...
          <div className="flex items-center gap-1.5 pointer-events-auto shrink-0">
            <button 
              ...
              className="w-7 h-7 sm:w-8 sm:h-8 bg-[#00224a] hover:bg-[#004691] text-white rounded-full flex items-center justify-center transition-colors shadow-xs hover:scale-105 active:scale-95"
            ...
            <button 
              ...
              className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center transition-colors shadow-xs hover:scale-105 active:scale-95 ${
                inWishlist 
            ...
            >
              <Heart className={`w-4 h-4 sm:w-[18px] sm:h-[18px] ${inWishlist ? "fill-[#004691]" : ""}`} />
            </button>
          </div>
        </div>
      </div>
