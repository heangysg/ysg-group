...
export default function CategorySubgrid({ category, subcategories }: { category: any, subcategories: any[] }) {
 ...
 <h1 className="text-xl md:text-4xl font-bold text-slate-900 mb-2 md:mb-4 uppercase">
 ...
 <div className="bg-white hover:-translate-y-1 md:hover:-translate-y-2 shadow-sm hover:shadow-md transition-all duration-300 flex flex-row md:flex-col h-full group rounded-md md:rounded-md overflow-hidden border border-slate-100">
 {/* Image Header */}
 ...
 {/* Mobile Title */}
 <h3 className="md:hidden text-[15px] font-bold text-slate-900 mb-1 truncate">
 {language === "kh" && subCat.nameKhmer ? subCat.nameKhmer : subCat.name}
 </h3>
 ...
 <div className="w-8 h-8 md:w-10 md:h-10 bg-primary/10 text-primary flex items-center justify-center rounded-md group-hover:bg-primary group-hover:text-white transition-colors">
